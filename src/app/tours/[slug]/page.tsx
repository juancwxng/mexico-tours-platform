...
export default async function TourDetailPage({
  ...
  const imageAlts = lang === "en" ? (tour.imageAltsEn ?? tour.imageAlts) : tour.imageAlts;
  ...
  const duration = lang === "en" ? (tour.durationEn ?? tour.duration) : tour.duration;
  const itinerary = lang === "en" ? (tour.itineraryEn ?? tour.itinerary) : tour.itinerary;
  ...
  return (
    <>
      ...
      <main className="pt-16 sm:pt-[4.5rem] lg:pt-20 pb-32 lg:pb-20">
        ...
        <div className="bg-[#f4f1ec] border-b border-gold/12 py-3">
          <Container>
            <div className="flex items-center gap-2 text-xs text-navy/60 font-bold uppercase tracking-wider">
              ...
              <Link href={`/tours?category=${tour.category}`} className="hover:text-gold transition-colors">
                {categoryLabel}
              </Link>
              <span className="text-gold/40">/</span>
        ...
        <Container className="mt-10 lg:mt-14">
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_380px] xl:grid-cols-[1fr_420px] gap-8 lg:gap-14 xl:gap-16 items-start">
            ...
            <div className="space-y-8 lg:space-y-10 order-2 lg:order-1">
              ...
              {/* Media gallery — placed directly after description for max attention */}
              {hasMedia && (
                <MediaGallerySection
        ...
        {/* BookingDrawer — id used by MediaGallerySection nudge on mobile */}
        <BookingDrawer
          tourTitle={tour.title}
          tourPrice={tour.price}
          priceList={tour.priceList}
