...
import { MapPin, Mail, Clock, MessageCircle, Instagram, Facebook, ArrowRight, PhoneCall } from "lucide-react";
...
export async function generateMetadata({
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}${withLang(lang, "/contact")}`,
      ...hreflangAlternates(baseUrl, "/contact"),
    },
  };
}
    ...
    <main className="pt-16 sm:pt-[4.5rem] lg:pt-20">
      <div className="bg-navy-section text-white py-16 lg:py-20 relative overflow-hidden">
        ...
        <Container className="relative z-10">
          ...
          <h1 className="font-display text-5xl md:text-6xl text-white mt-3 leading-none">{t("contact_title")}</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                ...
                >
                  ...
                  <p className="text-white/85 text-xs sm:text-sm leading-snug font-medium">
                    {isEn ? "Fast response for tour configurations and quotes." : "Respuesta rápida para armar tu paquete y cotizar."}
                  </p>
                </a>
                ...
                >
                  ...
                  <p className="text-white/85 text-xs sm:text-sm leading-snug font-medium">
                    {isEn ? "Direct cellular line for immediate offline support." : "Línea celular directa para atención personalizada."}
                  </p>
                </a>
              </div>
              ...
              <div className="grid sm:grid-cols-3 gap-4">
                ...
                >
                  ...
                  <h4 className="font-display text-navy font-bold text-sm mb-1">{isEn ? "Send an Email" : "Envíanos un Correo"}</h4>
                  <p className="text-navy/60 text-xs truncate">contacto@costafrancatours.com</p>
                </a>
                ...
                <div className="bg-white p-5 rounded-2xl border border-navy/10 shadow-sm text-left">
                  ...
                  <h4 className="font-display text-navy font-bold text-sm mb-1">{t("contact_location")}</h4>
                  <p className="text-navy/60 text-xs leading-relaxed">Mazatlán, Sinaloa, México</p>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-navy/10 shadow-sm text-left">
                  ...
                  <h4 className="font-display text-navy font-bold text-sm mb-1">{t("contact_hours")}</h4>
                  <p className="text-navy/60 text-xs leading-tight">
                    {isEn ? "Mon to Sun" : "Lun a Dom"}
                    <span className="block font-medium mt-0.5">8:00 AM – 10:00 PM</span>
                  </p>
                </div>
              </div>

              <div className="bg-navy-section rounded-2xl p-6 text-center">
                <h3 className="font-display text-lg text-white mb-4 font-medium">{t("contact_follow")}</h3>
                <div className="flex justify-center gap-4">
                  {[
                    { label: "WhatsApp", icon: MessageCircle, href: `https://wa.me/${waNumber}`, color: "#25D366" },
                    { label: "Instagram", icon: Instagram, href: "https://www.instagram.com/centraltoursmazatlan", color: "#C9A96E" },
                    { label: "Facebook", icon: Facebook, href: "https://www.facebook.com/PaseosMazatlanIslaPiedraVenadosCatamaranBanda", color: "#A8C8D8" },
                    { label: "TikTok", icon: TikTokIcon, href: "https://www.tiktok.com/@centraltoursmazatlan", color: "#ffffff" },
                  ].map((s) => (
                    <a
                      key={s.label}
                      href={s.href}
            ...
            <div className="relative h-[480px] lg:h-[580px] rounded-2xl overflow-hidden shadow-xl border border-navy/5">
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white space-y-1">
                <p className="font-display text-3xl font-medium tracking-wide">{t("contact_city")}</p>
                <p className="text-white/75 text-sm font-medium tracking-wide">{t("contact_city_sub")}</p>
              </div>
            </div>
          </div>
        </Container>
