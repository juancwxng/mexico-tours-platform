...
const FEATURES = [
  {
    ...
    desc: {
      es: "Trabajamos únicamente con prestadores de servicios seleccionados y verificados.",
      en: "We work only with carefully selected, verified service providers.",
    },
  },
  {
    icon: Award,
    ...
    desc: {
      es: "Cada tour está curado para ofrecerte la mejor experiencia en Mazatlán.",
      en: "Every tour is curated to give you the best Mazatlán experience.",
    },
  },
  {
    icon: Headphones,
    ...
    desc: {
      es: "Nuestro equipo está disponible por WhatsApp para atenderte en todo momento.",
      en: "Our team is available on WhatsApp to assist you at any time.",
    },
  },
  {
    icon: MapPin,
    ...
    desc: {
      es: "Somos de Mazatlán. Conocemos cada rincón y te guiamos con autenticidad.",
      en: "We're from Mazatlán. We know every corner and guide you with authenticity.",
    },
  },
];
