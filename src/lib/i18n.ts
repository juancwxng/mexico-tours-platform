...
const dict = {
  es: {
    ...
    // ── Footer ──
    footer_tagline:
      "Experiencias turísticas únicas en la Perla del Pacífico y destinos costeros de México.",
    footer_tours: "Tours",
    ...
    home_hero_subtitle:
      "Vive la Perla del Pacífico. Tours marítimos, aventura y cultura con los mejores operadores locales.",
    home_hero_cta: "Explorar Tours",
    home_featured: "Experiencias Destacadas",
    home_featured_sub:
      "Seleccionamos los mejores tours locales para que tu visita a Mazatlán sea perfecta.",
    ...
    tours_subtitle:
      "Más de {count} experiencias seleccionadas con los mejores operadores de la región.",
    ...
    tour_prev: "Imagen anterior",
    tour_next: "Siguiente imagen",
    tour_image: "Imagen",
    ...
    booking_wa_note:
      "Serás redirigido a WhatsApp para confirmar con un asesor.",
    ...
    contact_subtitle:
      "Estamos listos para ayudarte a vivir la mejor experiencia en Mazatlán y destinos costeros de México.",
  ...
  en: {
    ...
    // ── Footer ──
    footer_tagline:
      "Unique tourism experiences on the Pearl of the Pacific and Mexico's coastal destinations.",
    footer_tours: "Tours",
    ...
    home_hero_title: "Mazatlán",
    home_hero_subtitle:
      "Experience the Pearl of the Pacific. Boat tours, adventure, and culture with the best local operators.",
    home_hero_cta: "Explore Tours",
    home_featured: "Featured Experiences",
    home_featured_sub:
      "We handpick the best local tours so your visit to Mazatlán is unforgettable.",
    ...
    tours_subtitle:
      "Over {count} experiences selected with the best operators in the region.",
    ...
    booking_wa_note:
      "You'll be redirected to WhatsApp to confirm with an advisor.",
    ...
    contact_subtitle:
      "We're ready to help you have the best experience in Mazatlán and Mexico's coastal destinations.",
    ...
    not_found_sub:
      "The page you're looking for doesn't exist or was moved. Go back to the homepage to keep exploring.",
